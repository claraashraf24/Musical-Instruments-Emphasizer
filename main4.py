...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def open_audio_file(self):
        ...
        self.frequency, self.time, self.Sxx = signal.spectrogram(self.signal, self.fs)
        self.spectrogram_widget.canvas.axes.pcolormesh(self.time, self.frequency, self.Sxx, shading='auto', cmap=self.colormap)
