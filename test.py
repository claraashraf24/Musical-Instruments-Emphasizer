...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.piano_volume_slider.valueChanged.connect( self.adjust_volume)
        self.piano_volume_slider.valueChanged.connect( self.slider_text)
        self.drums_volume_slider.valueChanged.connect( self.adjust_volume)
        self.drums_volume_slider.valueChanged.connect( self.slider_text)
        self.xylo_volume_slider.valueChanged.connect( self.adjust_volume)
        self.xylo_volume_slider.valueChanged.connect( self.slider_text)
    ...
    def slider_text(self, value):
        ...
        self.drums_volume_number.setText(str(value))
    ...
    def open_audio_file(self):
        ...
        # self.spectrogram_widget.addWidget(self.Canvas,0, 0, 1, 1)
